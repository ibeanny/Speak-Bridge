...
function App() {
  ...
  return (
    ...
    // ============================
      <div className="relative min-h-screen flex items-center justify-center px-4 md:px-6 py-6 text-[#f3e9ff] overflow-hidden">
      ...
      */}
        <div
            className="w-full max-w-6xl bg-[#1a1028]/80 border border-[#3c1361] rounded-2xl shadow-[0_20px_60px_rgba(64,0,128,0.6)] overflow-hidden flex flex-col backdrop-blur-sm">
          {/* ============================
            HEADER
            - Icon + app title
           ============================ */}
          ...
          {/* ============================
           ...
           ============================ */}
          <main className="px-4 md:px-6 py-3 bg-[#1a1028]/80 min-h-0 flex-1">
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="flex flex-col gap-2">
                ...
                <div
                  ...
                  {/* Camera header strip */}
                  <div
                      className="flex items-center justify-between px-3 py-1.5 border-b border-[#4c1d95]/50 text-[0.7rem] text-purple-200/70">
                ...
                {/* HAND STATUS BOX */}
                <div
                    className="bg-[#2a1b3d] border border-[#4c1d95] rounded-lg px-3 py-2 text-sm text-purple-100 shadow-[0_0_15px_rgba(147,51,234,0.2)] flex items-center justify-between gap-2">
                  {/* Text showing what the system sees */}
                  <span className="truncate">{handStatus}</span>

                  {/* "Camera Active" pill + pulse dot */}
                  <span
                      className="inline-flex items-center gap-1 rounded-full border border-purple-400/60 bg-purple-500/20 px-2 py-0.5 text-[0.6rem] font-semibold text-purple-200 uppercase tracking-wide whitespace-nowrap">
              ...
              {/* ============================
               ...
               ============================ */}
              <div
                  className="bg-[#2a1b3d] border border-[#4c1d95] rounded-xl shadow-[0_0_20px_rgba(147,51,234,0.25)] flex flex-col">
                {/* Output header strip */}
                <div
                    className="flex items-center justify-between px-3 py-1.5 border-b border-[#4c1d95]/50 text-[0.7rem] text-purple-200/70">
                <span className="flex items-center gap-2">
